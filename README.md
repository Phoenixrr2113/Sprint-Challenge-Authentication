...
- to create an ideal UX where a user doesnt have to login after ever page refresh.

1. What does bcrypt do to help us store passwords in a secure manner.

- Bcrypt hashes a users password a set number of times that makes it harder for hackers to steal their info.
